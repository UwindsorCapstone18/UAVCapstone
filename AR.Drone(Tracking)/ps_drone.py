...
######################=-
	...
	def moveLeftUp(self,*args):
		try:	speed=args[0]
		except:	speed=self.__speed
		self.move(-self.__checkSpeedValue(speed),0.0,self.__checkSpeedValue(speed),0.0)


	def moveLeftDown(self, *args):
		try:
			speed = args[0]
		except:
			speed = self.__speed
